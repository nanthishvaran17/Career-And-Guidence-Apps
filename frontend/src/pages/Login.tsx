...
export function Login() {
  ...
  const handleOtpSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      localStorage.setItem('loginAt', loginAt); // For session duration on logout
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="p-8">
          ...
          <Button
            type="button"
            variant="outline"
            className="w-full h-12 border-gray-200 hover:bg-gray-50 flex items-center justify-center gap-3 text-gray-700 font-semibold"
