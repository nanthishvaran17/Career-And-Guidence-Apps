  ...
  return (
    <div ref={wrapperRef} className="relative w-full">
      <form onSubmit={handleSubmit} className="relative group">
        <button 
          type="submit"
          className="absolute left-2.5 top-1/2 -translate-y-1/2 p-2 hover:bg-gray-100 rounded-full transition-colors z-20"
        >
          <Search className="w-[18px] h-[18px] text-gray-500 group-focus-within:text-blue-600 transition-colors" />
        </button>
        <input
          type="text"
          value={query}
          ...
          className="w-full pl-14 pr-10 py-2.5 rounded-xl border border-gray-200 bg-gray-50 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 focus:bg-white transition-all shadow-sm hover:shadow-md"
        />
        {query && (
          <button 
            type="button"
